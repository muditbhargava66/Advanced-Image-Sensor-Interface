...
class AdvancedSensorSystem:
    ...
    def _optimize_memory_usage(self) -> None:
        ...
        if self.buffer_manager:
            ...
            optimization_task = asyncio.create_task(asyncio.to_thread(self.buffer_manager.optimize_pools))
    ...
    def initialize_system(self) -> bool:
        ...
        try:
            ...
            self.buffer_manager = AsyncBufferManager(pool_size=200)
    ...
    async def _update_application_metrics(self) -> None:
        ...
        stats = self.buffer_manager.get_stats() if self.buffer_manager else None
        buffer_utilization = float(stats.current_pool_size) if stats else 0.0
